...
public class App {
	public static void main(String[] args) throws VendingMachinePersistenceException {
		/*
		 * UserIO myIO = new UserIOConsoleImpl(); VendingMachineView myView = new
		 * VendingMachineView(myIO); VendingMachineDao myDao = new
		 * VendingMachineDaoImpl(); VendingMachineAuditDao myAuditDao = new
		 * VendingMachineAuditDaoImpl(); VendingMachineServiceLayer myService = new
		 * VendingMachineServiceLayerImpl(myDao, myAuditDao); VendingMachineController
		 * myController = new VendingMachineController(myView, myService);
		 * myController.run();
		 */
